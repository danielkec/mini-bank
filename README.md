...
curl -v -X PUT --json '{"from":"AB448", "to":"AB447", "amount":"100"}' localhost:8080/transaction/transfer

# Transfers money to non-existent account, LRA TX is cancelled and money refunded to A   
curl -v -X PUT --json '{"from":"AB448", "to":"AB404", "amount":"100"}' localhost:8080/transaction/transfer
